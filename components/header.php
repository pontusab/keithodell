			...
			<div class="wrapper <?php echo ( isset( $img ) ? '' : 'no-img' ); ?>">
				...
				<div class="innerwrapper">
					...
					<div class="header <?php echo ( isset( $start ) ? '' : 'other' ); ?>">
						...
						<ul class="lang">
							<li class="lang-item lang-item-2 lang-item-sv"><a hreflang="sv" href="http://keithodell.dev/sv/">Svenska</a></li>
							<li class="lang-item lang-item-4 lang-item-en current-lang"><a hreflang="en" href="http://keithodell.dev">English</a></li>
						</ul>
					</div>